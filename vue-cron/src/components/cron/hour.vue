<template lang="html">
  <div :val="value_">
    <a-radio-group v-model="type">
      <div>
        <a-radio :value="1" border>每时</a-radio>
      </div>
      <div>
      ...
      <div>
        ...
        <span style="margin-left: 10px; margin-right: 5px;">从</span>
        <a-input-number @change="type =3" v-model="loop.start" :min="0" :max="23" style="width: 100px;"></a-input-number>
        <span style="margin-left: 5px; margin-right: 5px;">时开始，每</span>
        <a-input-number @change="type = 3" v-model="loop.end" :min="1" :max="23" style="width: 100px;"></a-input-number>
        时执行一次
      </div>
      <div>
