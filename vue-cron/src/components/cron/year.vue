<template lang="html">
  <div :val="value_">
    <a-radio-group v-model="type">
      <div>
        <a-radio :value="1" border>每年</a-radio>
      </div>
      <div>
      ...
      <div>
        ...
        <a-input-number @change="type = 2" v-model="cycle.start" :min="2000" style="width: 100px;"></a-input-number>
        <span style="margin-left: 5px; margin-right: 5px;">至</span>
        <a-input-number @change="type = 2" v-model="cycle.end" :min="2000"  style="width: 100px;"></a-input-number>
        年
      </div>
    </a-radio-group>
  </div>
